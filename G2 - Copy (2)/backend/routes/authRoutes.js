...
router.post(
    ...
    async (req, res) => {
        ...
        try {
            const { firstName, middleName, lastName, age, gender, phone, email, homeAddress, username, password } = req.body;
...
router.put('/profile', authMiddleware, upload.single('profilePhoto'), async (req, res) => {
    try {
        ...
        const { firstName, lastName, username, email, phone, age, gender, homeAddress, password } = req.body;
