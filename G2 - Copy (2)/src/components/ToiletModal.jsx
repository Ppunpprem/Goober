      ...
      <div className="flex flex-col sm:flex-col md:flex-row w-full gap-3 sm:gap-4 md:gap-5 lg:gap-6 overflow-auto scrollbar-thin pb-4 pt-0">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg w-full md:w-1/2 lg:w-1/4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <h3 className="text-xs sm:text-xs md:text-xs mb-2 sm:mb-3 md:mb-4 text-indigo-900 text-left w-full">"Please Login/SignUp before use</h3>
        ...
        {/* Container 4 - Login Prompt */}
        <div className="bg-white p-3 sm:p-4 rounded-lg w-full md:w-1/2 lg:w-1/4 flex items-center justify-center text-center min-h-[100px]">
          <h3 className="text-base sm:text-lg md:text-xl font-bold text-indigo-900">
