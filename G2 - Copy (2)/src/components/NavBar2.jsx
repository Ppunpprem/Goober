    ...
    <>
      ...
      {showAddTrashcanPopup && (
        <div className="fixed inset-0 bg-transparent bg-opacity-50 flex justify-center items-center z-50 pointer-events-none">
          <div className="bg-white p-6 rounded-3xl shadow-xl w-96 pointer-events-auto">
            <h2 className="title">Add a Trashcan!</h2>
            ...
            <div className="mb-4 flex gap-4">
              <div className="flex-1">
                <label className="block text-[#17005a] text-2xl font-medium">
                  2. Location
                </label>
                <input
                  type="text"
              ...
              <div className="w-24">
                <label className="block text-[#17005a] text-2xl font-semibold">
                  Floor
                </label>
                <input
                  type="text"
