...
{showAddTrashcanPopup && (
  <div className={`fixed top-16 sm:top-20 right-0 bg-transparent bg-opacity-50 flex justify-center items-center z-50 ${
    ...
    <div className="bg-white p-6 rounded-3xl shadow-xl w-96 max-w-xs sm:max-w-md max-h-[90dvh] overflow-y-auto">
      ...
      <div className="mb-4 flex gap-4">
        <div className="flex-1">
          <label className="text-[#17005a] text-lg sm:text-2xl font-medium">2. Location</label>
          <input
            type="text"
        ...
        <div className="w-24">
          <label className="block text-[#17005a] text-lg sm:text-2xl font-semibold">Floor</label>
          <input
            type="text"
            placeholder="Floor?"
            className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 text-[#17005a]-800"
